...
- Changed our buggy routing system, now it should work flawlessly, for more info, please refer to our [live docs here](https://demos.strixdigital.in/material-dashboard-react/#/documentation/routing-system)
...
- Added design from Dashboard by Strix Digital
